...
def TTRSolver(dynamics_obj, grid, init_value, obstcle_map, epsilon, plot_option):
    print("Welcome to optimized_dp \n")
    ################# INITIALIZE DATA TO BE INPUT INTO EXECUTABLE ##########################
    ...
    obstcle_map = hcl.asarray(obstcle_map)
    ...
    while error > epsilon:
        ...
        count += 1
        if grid.dims == 3:
            solve_TTR(V_0, list_x1, list_x2, list_x3, obstcle_map)
        if grid.dims == 4:
